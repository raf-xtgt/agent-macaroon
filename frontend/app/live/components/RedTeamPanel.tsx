    ...
    <div className="border border-slate/30 rounded-lg bg-ink p-4 font-mono text-xs space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <select
          ...
          className="min-w-[180px] max-w-xs px-3 py-1.5 bg-ink border border-slate/40 rounded text-parchment font-mono text-xs focus:outline-none focus:border-gemma-purple focus:ring-1 focus:ring-gemma-purple disabled:opacity-50 cursor-pointer"
        >
          {objectives.length === 0 ? (
